...
<main role="main">
  ...
  <div class="container">  
    ...
    <form method="post" action="<%= URL.Absolute("paymethods/edit/"+paymethod.getId(), request) %>">
        ...
        <div class="row">
            <div class="col-md-5 mb-3">
              ...
              <input type="text" class="form-control" id="cardName" name="cardName" placeholder="John Smith" value="<%= v.repopulate("cardName", paymethod.getCardName()) %>" >
            </div>

            <div class="col-md-4 mb-3">
              <label for="cardNumber">Number</label>
              <input type="text" class="form-control" id="cardNumber" name="cardNumber" placeholder="4012 8888 8888 1881" value="<%= v.repopulate("cardNumber", paymethod.getCardNumber()) %>">
            </div>

            <div class="col-md-2 mb-3">
              <label for="cardCVV">CVV</label>
              <input type="text" class="form-control" id="cardCVV" name="cardCVV" placeholder="123" value="<%= v.repopulate("cardCVV", paymethod.getCardCVV()) %>">
            </div>
        </div>
        <div class="row">
           <div class="col-md-4 mb-3">
