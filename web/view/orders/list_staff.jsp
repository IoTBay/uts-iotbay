...
<main role="main">
  ...
  <div class="container">  
    ...
    <form method="post" action="<%= URL.Absolute("staff/orders/search", request) %>" class="form-inline">
        ...
        <a class="btn btn-secondary" href="<%= URL.Absolute("staff/orders/list", request) %>">Back to full list</a>
    </form>
